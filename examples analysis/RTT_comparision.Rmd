...
get_pathStability <- function(paths){
  ...
  paths_stability_df$dateStart <- as.POSIXlt(dateStart) - 3600*3
  paths_stability_df$dateFinish <- as.POSIXlt(dateFinish) - 3600*3
  #paths_stability_df$mbAdditions <- mb_additions
  #paths_stability_df$mbDeletions <- mb_deletions
  return(paths_stability_df)
}

plot_comparision_rtt <- function(RTT){
...
# probabilidad de densidad RTT para IP `r addr` 
...
#print("rtt")
if(nrow(rtt) != 0){
  print(plot_comparision_rtt(rtt) )
}
```
